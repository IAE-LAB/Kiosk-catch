...
export default function LR_Kiosk_explore_tutorial_1({navigation}) {
    return (
        <View style={styles.contents}>
            ...
            <TouchableOpacity
                ...
                <View style={styles.taskBox}>
                    <TouchableOpacity>
                        <Icon_FontAwesome name="angle-right" size={40} style={styles.tutorial_category_icon} />
                    </TouchableOpacity>
                </View>
                ...
                <View style={styles.taskBubble}>
                    ...
                    <View style={styles.taskIofo}>
                        ...
                        <Text style={styles.taskTxt}>더 많은 카테고리를 확인할 수 있어요</Text>
                    </View>
                </View>

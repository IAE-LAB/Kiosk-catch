...
export default function CB_Kiosk_Payment_methods_card({navigation}) {
    return (
                ...
                <View style={styles.optionContainer}>
                    ...
                    <View style={styles.optionContents}>
                        ...
                        <View style={styles.optionPayment}>
                            <TouchableOpacity style={styles.paymentBtn_2}>
                                <Icon_MaterialCommunityIcons name="credit-card-outline" size={40} style={{color: 'white'}} />
                                <Text style={styles.pay_text_2}>신용카드</Text>
                                <Text style={styles.pay_text_2}> </Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={styles.paymentBtn_1}>
                                <Icon_MaterialCommunityIcons name="ticket-percent-outline" size={40} style={{color: '#E02649'}} />
                                <Text style={styles.pay_text_1}>모바일</Text>
                                <Text style={styles.pay_text_1}>쿠폰</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={styles.paymentBtn_1}>
                                <Icon_MaterialCommunityIcons name="barcode" size={40} style={{color: '#E02649'}} />
                                <Text style={styles.pay_text_1}>포인트</Text>
                                <Text style={styles.pay_text_1}>사용</Text>
                            </TouchableOpacity>
                        </View>
                        ...
                        <View style={styles.optionBtn}>
                            ...
                            onPress={() => navigation.navigate('CB_Kiosk_Payment_card_paying')}>

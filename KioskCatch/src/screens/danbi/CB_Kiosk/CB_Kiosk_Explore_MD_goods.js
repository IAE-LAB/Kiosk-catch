...
export default function CB_Kiosk_Explore_MD_goods({navigation}) {
    return (
        <View style={styles.contents}>
            ...
            <View style={styles.category_detail}>
                <TouchableOpacity onPress={() => navigation.navigate('CB_Kiosk_Explore_MD_tumbler')}>
                    <Text style={styles.category_text3}>텀블러</Text>
                </TouchableOpacity>
                <TouchableOpacity>
                    <Text style={styles.category_text1}>굿즈</Text>
                </TouchableOpacity>
                {/* <TouchableOpacity>
            ...
            <View style={styles.main}>
                ...
                <View style={styles.menu}>
                    <View style={styles.menuRow}>
                        ...
                        >
                            <Image
                                source={require('KioskCatch/assets/img/CB_Kiosk/picnic_table.png')}
                                style={styles.menuImage}>
                            </Image>
                            <View style={{flexDirection: 'column'}}>
                                <Text style={styles.menuTxt}>피그닉</Text>
                                <Text style={styles.menuTxt}>테이블</Text>
                                <Text style={styles.menuTxt}>27,900원</Text>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.menuBtn}
                        // onPress={() => navigation.navigate('Kiosk_update')}
                        >
                            <Image
                                source={require('KioskCatch/assets/img/CB_Kiosk/picnic_chair.png')}
                                style={styles.menuImage}>
                            </Image>
                            <View style={{flexDirection: 'column'}}>
                                <Text style={styles.menuTxt}>피크닉</Text>
                                <Text style={styles.menuTxt}>체어</Text>
                                <Text style={styles.menuTxt}>29,900원</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.menuRow}>
                        ...
                        >
                            <Image
                                source={require('KioskCatch/assets/img/CB_Kiosk/phone_case_set.png')}
                                style={styles.menuImage}>
                            </Image>
                            <View style={{flexDirection: 'column'}}>
                                <Text style={styles.menuTxt}>핸드폰</Text>
                                <Text style={styles.menuTxt}>케이스세트</Text>
                                <Text style={styles.menuTxt}>9,900원</Text>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.menuBtn}>
                            <Image
                                source={require('KioskCatch/assets/img/CB_Kiosk/daily_lunch_bag.png')}
                                style={styles.menuImage}>
                            </Image>
                            <View style={{flexDirection: 'column'}}>
                                <Text style={styles.menuTxt}>데일리</Text>
                                <Text style={styles.menuTxt}>런치백</Text>
                                <Text style={styles.menuTxt}>19,900원</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.menuRow}>

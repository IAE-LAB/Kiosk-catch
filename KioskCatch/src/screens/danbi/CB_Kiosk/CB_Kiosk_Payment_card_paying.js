...
export default function CB_Kiosk_Payment_card_paying({navigation}) {
    return (
            ...
            <View style={styles.overlay}>
                <View style={styles.optionContainer}>
                    ...
                    <View style={styles.optionTitle}>
                        <Text style={styles.optionTitleText}>신용카드 결제</Text>
                    </View>
                    ...
                    <View style={styles.optionContents}>
                        ...
                        <View style={styles.optionCoupon}>
                            <TouchableOpacity style={styles.couponInfo}>
                                <Text style={styles.coupon_text_1}>결제하실 신용카드를 카드투입구에 넣고</Text>
                                <Text style={styles.coupon_text_1}>결제가 완료될 때까지 기다려 주세요.</Text>
                                <Text style={styles.coupon_text_2}>(도중에 제거하지 마세요.)</Text>
                            </TouchableOpacity>
                        </View>
                        ...
                        <View style={styles.optionImage}>
                            ...
                            onPress={() => navigation.navigate('CB_Kiosk_Payment_card_complete')}>
                                <Image
                                    source={require('KioskCatch/assets/img/kiosk/card.png')}

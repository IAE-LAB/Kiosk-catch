...
export default function CB_Kiosk_Explore_coffee_option({navigation}) {
    return (
                ...
                <View style={styles.optionContainer}>
                        ...
                        <View style={styles.optionMenuDetail}>
                            <View style={styles.optionMenuChoose}>
                                ...
                                <View style={styles.optionMenuChoose_btn}>
                                    ...
                                    onPress={() => navigation.navigate('CB_Kiosk_Explore_coffee_option_choose')}
                                    >
                                        <Image
                                        source={require('KioskCatch/assets/img/CB_Kiosk/iced-coffee_ice_g.png')}
                                        style={styles.temperatureImage_ice}
                                        />
                                        <Text style={styles.temperature_txt}>아이스</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={styles.optionMenuChoose_btn_1}>
                                        <Image
                                        ...
                                        />
                                        <Text style={styles.temperature_txt}>핫</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                            <View style={styles.optionMenuChoose}>
                                ...
                                <View style={styles.optionMenuChoose_btn}>
                                    ...
                                    onPress={() => navigation.navigate('CB_Kiosk_Explore_coffee_option_choose')}>
                                        <Image
                                        source={require('KioskCatch/assets/img/CB_Kiosk/cup_size_s_g.png')}
                                        style={styles.optionImage_size_1}
                                        />
                                        <Text style={styles.temperature_txt}>레귤러</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={styles.optionMenuChoose_btn_1}>
                                        <Image
                                        ...
                                        />
                                        <Text style={styles.temperature_txt}>라지</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={styles.optionMenuChoose_btn_1}>
                                        <Image
                                        ...
                                        />
                                        <Text style={styles.temperature_txt}>맥스</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                            <View style={styles.optionMenuChoose}>
                                ...
                                <View style={styles.optionMenuChoose_btn}>
                                    <TouchableOpacity style={styles.optionMenuChoose_btn_1}>
                                        ...
                                        style={styles.optionImage_size_2}
                                        />
                                        <Text style={styles.temperature_txt}>일회용</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={styles.optionMenuChoose_btn_1}
                                    onPress={() => navigation.navigate('CB_Kiosk_Explore_coffee_option_choose')}>
                                        <Image
                                        source={require('KioskCatch/assets/img/CB_Kiosk/mug_cup_g.png')}
                                        style={styles.optionImage_size_3}
                                        />
                                        <Text style={styles.temperature_txt}>머그컵</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                        </View>
                    ...
                    <View style={styles.optionBottomBtn}>
                        <TouchableOpacity
                            ...
                            onPress={() => navigation.navigate('CB_Kiosk_Explore_coffee')}>

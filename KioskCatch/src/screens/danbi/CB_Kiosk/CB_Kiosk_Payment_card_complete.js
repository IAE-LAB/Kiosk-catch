...
export default function CB_Kiosk_Payment_card_complete({navigation}) {
    return (
            ...
            <View style={styles.overlay}>
                <View style={styles.optionContainer}>
                    ...
                    <View style={styles.optionTitle}>
                        <Text style={styles.optionTitleText}>결제 완료</Text>
                    </View>
                    ...
                    <View style={styles.optionContents}>
                        ...
                        <View style={styles.orderNumber}>
                            ...
                            >
                                ...
                                <Text style={styles.orderNumber_text_1}>음료가 준비되면 알려드립니다.</Text>
                            </TouchableOpacity>
                        </View>

...
const LR_Kiosk_Tutorial_Packaging = ({ closePopup }) => {
    ...
    return (
        <TouchableOpacity style={styles.tutorial_contents}
            ...
            <View style={styles.taskName}>
                <Text style={styles.taskName_text}>포장선택</Text>
            </View>
            ...
            <View style={styles.taskBubble}>
                ...
                <View style={styles.taskIofo}>
                    ...
                    <Text style={styles.taskTxt}>원하는 포장방식을 선택해보세요</Text>
                </View>
            </View>
...
export default LR_Kiosk_Tutorial_Packaging;

...
const PaymentCoupon = ({ closePopup }) => {
            ...
            <View style={styles.optionContents}>
                ...
                <View style={styles.optionCoupon}>
                    <TouchableOpacity style={styles.couponInfo}>
                        ...
                        <Text style={styles.coupon_text_1}>아래 바코드 리더기에 스캔해주세요</Text>
                        <Text style={styles.coupon_text_2}>*쿠폰의 바코드 인식이 안될 경우 쿠폰번호를 입력하세요</Text>
                    </TouchableOpacity>
                </View>

                {/*사용 그림*/}
                <View style={styles.optionImage}>
                    <TouchableOpacity style={styles.imageBtn} onPress={() => setOpen(true)}>
                        <Image

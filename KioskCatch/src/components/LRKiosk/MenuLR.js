    ...
    return (
      <View style={styles.menu_LR}>
        <TouchableOpacity style={styles.LR_btn}>
          <Text style={styles.LR_text}
            onPress={() => PreviousChangeHandler(props.CategoryState,props.PageState,props.setPageState)}
          >이전</Text>
        </TouchableOpacity>
        ...
        {props.state[0] === '2-2' ? (
          ...
          <TouchableOpacity 
          style={styles.LR_btn}
          onPress={() => NextChangeHandler(props.CategoryState,props.PageState,props.setPageState)}>
            <Text style={styles.LR_text}>다음</Text>
          </TouchableOpacity>
        )}
      </View>
